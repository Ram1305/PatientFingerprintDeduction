...
String pass=request.getParameter("pass");
  // out.print(name+""+pass);
    String qry="select * from doctor_details where username='"+name+"' && password='"+pass+"' ";
	//	out.print(qry);
 ...
 <!-- main image slider container -->
    ...
    <section class="wthree-row w3-contact py-lg-5">
            ...
            <div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">Doctor Login </h3>
				<p class="w3l-sub">&nbsp;</p>
			  <form name="form1" method="post" action="">
			    <table width="37%" height="115" border="0" align="center">
                    ...
                    <tr>
                      <td class="tdsh">&nbsp;</td>
                      <td colspan="2" class="tdsh"><a href="doctor_register.jsp">New User Registe Here... </a></td>
                    </tr>
                </table>
			  </form>
			  </div>
