...
<%
String p_k=(String)session.getAttribute("pk");
...
if(a.equals("Submit"))
{
 String k1=request.getParameter("key");
 if(k1.equals(p_k))
 {
    response.sendRedirect("download.jsp?file1="+file);  
 ...
 else
 {
    %>
		...
		alert("Key Not Matched");
                window.location="user_view_data.jsp";
		</script>
 ...
 <!-- main image slider container -->
    ...
    <section class="wthree-row w3-contact py-lg-5">
            ...
            <div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">Key Verification</h3>
				<p class="w3l-sub">&nbsp;  </p>
				<p class="w3l-sub">&nbsp;</p>
			  <form name="form1" method="post" action="">
			    <table width="333" height="105" border="0" align="center">
                  <tr>
                    <td>Private Key </td>
                    <td><label>
                      <input name="key" type="text" id="key" required="">
                    </label></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
