                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item   mr-3 mt-lg-0 mt-3">
                        ...
                        <li class="nav-item mr-3 mt-lg-0 mt-3 active">
                            <a class="nav-link" href="user_view_data.jsp">View Data</a>
                        </li>
                        
                         <li class="nav-item mr-3 mt-lg-0 mt-3">
                            <a class="nav-link" href="user_doctor_details.jsp">Doctor Details</a>
                        </li>
                        <li class="nav-item ">
 ...
 <!-- main image slider container -->
    ...
    <section class="wthree-row w3-contact py-lg-5">
            ...
            <div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">View Data</h3>
				<table width="670" height="106" border="0" align="center">
          <%
  ResultSet rs0=stmt3.executeQuery("select * from user_files where user='"+user+"'");
		int s=0;	
                   while(rs0.next())
			{
                         if(s==0)
          ...
          <tr>
            ...
            <td width="111"><h4><strong><span class="style1">Download</span></strong></h4></td>
          </tr>
          <% 
                         }
			  s++;
...
%>
          <tr>
            ...
            <td><a href="user_view_data_1.jsp?id=<% out.print(rs0.getString("id"));%>">Click</a></td>
          </tr>
          <%
