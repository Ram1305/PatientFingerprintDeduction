...
String ins = "insert into user_details  values('"+id2+"','" + name + "' ,'" + cont + "','"+email+"','"+address+"','"+uname+"','"+pass+"','" + cdate + "','0','0')";  
...
//                         int n2 = stmt2.executeUpdate(ins1);
                  response.sendRedirect("user_register_1.jsp");
 ...
 <!-- main image slider container -->
    ...
    <section class="wthree-row w3-contact py-lg-5">
            ...
            <div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">User Registration </h3>
				<p class="w3l-sub">&nbsp;</p>
