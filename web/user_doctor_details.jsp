 ...
 <!-- main image slider container -->
    ...
    <section class="wthree-row w3-contact py-lg-5">
            ...
            <div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">doctor Details</h3>
				<table width="904" height="106" border="0" align="center">
          <%
  ResultSet rs0=stmt3.executeQuery("select * from doctor_details");
		int s=0;	
                   while(rs0.next())
			{
                         if(s==0)
          ...
          <tr>
            ...
            <td width="115"><h4>Qualification</h4></td>
            <td width="115"><h4>Edperiance</h4></td>
...
%>
          <tr>
            ...
            <td><span class="style7">
              <% out.print(rs0.getString("qualification"));%>
            </span></td>
            <td><span class="style7">
              <% out.print(rs0.getString("edperiance"));%>
            </span></td>
            <td><span class="style7">
